...
void GPIO_setPinDirection(Uint8 a_port , Uint8 a_pin, Uint8 a_mode)
{
 switch(a_port)
 {
  case 0 :
                          switch(a_mode)
                          {
                              case 0 : ((TRISA)|=(1<<a_pin)); break;
                              case 1 : ((TRISA)&=(~(1<<a_pin))); break;
                          }
                           break;
  case 1 :
                         switch(a_mode)
                          {
                              case 0 : ((TRISB)|=(1<<a_pin)); break;
                              case 1 : ((TRISB)&=(~(1<<a_pin))); break;
                          }
                           break;
  case 2 :
                         switch(a_mode)
                          {
                              case 0 : ((TRISC)|=(1<<a_pin)); break;
                              case 1 : ((TRISC)&=(~(1<<a_pin))); break;
                          }
                           break;
  case 3 :
                         switch(a_mode)
                          {
                              case 0 : ((TRISD)|=(1<<a_pin)); break;
                              case 1 : ((TRISD)&=(~(1<<a_pin))); break;
                          }
                           break;
  case 4 :
                         switch(a_mode)
                          {
                              case 0 : ((TRISE)|=(1<<a_pin)); break;
                              case 1 : ((TRISE)&=(~(1<<a_pin))); break;
                          }
                           break;
 }
...
Uint8 GPIO_getPinValue(Uint8 a_port , Uint8 a_pin)
{
 ...
 switch(a_port)
 {
  case 0 : Local_Value=((PORTA)&=(1<<a_pin)); break;
  case 1 : Local_Value=((PORTB)&=(1<<a_pin)); break;
  case 2 : Local_Value=((PORTC)&=(1<<a_pin)); break;
  case 3 : Local_Value=((PORTD)&=(1<<a_pin)); break;
        case 4 : Local_Value=((PORTE)&=(1<<a_pin)); break;
  default : break;
 }
 return Local_Value;
}
